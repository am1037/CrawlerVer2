...
public interface TheaterMapper {
    ...
    TheaterVO selectOneTheaterById(@Param("theater_company") String theater_company, @Param("theater_id") String theater_id);

    @Select("SELECT * FROM popcorn.theater WHERE theater_company = #{theater_company}")
    List<TheaterVO> selectListByCompanyName(@Param("theater_company") String theater_company);
